...
function Belowfotter () {
    return<>
    
    <div className="max-w-[100%] h-[136px] mt-[74px]  z-999 " style={{ backgroundColor: 'rgb(240,240,245)', border: 'px solid rgba(2,6,12,0.1)'}}>
  <div className="grid grid-cols-1 sm:grid-cols-2 h-full items-center">

            <div className="ml-12 text-[28px] font-bold ">
                 For better experence, Download the swiggy app now
            </div>
        
  <div className=" flex gap-6 ml-5">
  <img
  className="sc-koXPp fKIURO sc-eHsDsR eiYKkW max-w-[201.64px] h-[64px]"
  src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/m/play_store.png"
  alt="Download Android App"
  />
  <img
  className="sc-koXPp fKIURO sc-eHsDsR eiYKkW max-w-[186] h-[64px]"
...
/>
    ...
    <div className="max-w-[100%] h-[494px] bg-black flex justify-center">
...
<div className="max-w-[1240px]  w-full  ">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 text-[24px] font-bold" style={{color:'#ffffffeb'}}>

        < div className="  mt-[48px] " style={{color:'#ffffffeb'}}>
        
        

          <div className="flex gap-3"> 
          
        <span className="sc-gvPdwL epioVU">
  <svg
    width={21}
    height={32}
    viewBox="0 0 21 32"
    ...
    <defs>
      ...
      >
        ...
        <div>Swiggy</div>
          ...
          <h5 className="text-[16px]" style= {{color:'#ffffff99'}}>@2024 Bunds Technologies Pvt.Ltd</h5>

        </div>

        < div className="mt-[48px] ">
          Company
          <ul className="text-[16px] space-y-3" style= {{color:'#ffffff99'}}>
            <li>
                About
            </li>
            <li>
